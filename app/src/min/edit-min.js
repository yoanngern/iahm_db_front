...
angular.module('iahmDBApp.editView', ['ngRoute'])
    ...
    .config(['$routeProvider', function ($routeProvider) {
        $routeProvider.when('/doc/:doc_type?/:id?/edit', {
    ...
    .controller('editCtrl', ['$scope', '$http', '$routeParams', function ($scope, $http, $routeParams) {
        ...
        $http.get('http://iahmdb.local/app_dev.php/api/' + api_path + '/' +
            $scope.doc.id + "?access_token=" +
        ...
        $scope.saveDoc = function () {
            ...
            data.event.start = '2011-06-05 12:15:00';
            data.event.end = '2012-06-05 12:15:00';
            data.event.parent = 2;
            data.event.persons = [];
            data.event.groups = [];
            ...
            */
            ...
            $http.put('http://iahmdb.local/app_dev.php/api/' + api_path + '/' +
                $scope.doc.id + "?access_token=" +
